...
public class PhoneBookManager {
    ...
    public void writeCSV(){
        ...
        for(PhoneList phoneList:phoneList1) {
            entries.add(phoneList.toString());
            entries.add(phoneList.getGroup());
            entries.add(phoneList.getName());
            entries.add(phoneList.getGender());
            entries.add(phoneList.getAddress());
            entries.add(phoneList.getBirthday());
            entries.add(phoneList.getEmail());
        }
        try (
